        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active rounded">
              <img src="{{  ('assets/images/'.$homes[0]->slide1 ) }}" class="d-block w-100 rounded" alt="...">
            ...
            <div class="carousel-item  rounded">
              <img src="{{ ('assets/images/'.$homes[0]->slide2 )}}" class="d-block w-100 rounded" alt="...">
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item  rounded">
              <img src="{{  ('assets/images/'.$homes[0]->slide3 ) }}" class="d-block w-100 rounded" alt="...">
              <div class="carousel-caption d-none d-md-block">
